...
mods:     { text: '🌸 Este comando solo lo pueden usar los moderadores. ¡Respeta las reglas! 💢', ctx: ctxDev },
premium:  { text: '🌸 Este comando es exclusivo para usuarios premium~ 💖 ¿Tú lo eres? 🙃', ctx: ctxDenied },
group:    { text: '🌸 ¡Baka! Este comando solo se puede usar en grupos, ¿qué parte no entiendes? 😡', ctx: ctxInfo },
