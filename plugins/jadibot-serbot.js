...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `genial @${m.sender.split('@')[0]}, Hemos despegado 🚀 a una nueva aventura en la galaxia 🌌.`, mentions: [m.sender]}, { quoted: m }) : ''
