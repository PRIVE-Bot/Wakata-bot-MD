...
async function handler(m, { conn }) {
  ...
  const creadores = [
    { numer: '526641804242', nombre: 'Brayan', descripcion: 'Creador de bots y desarrollador' },
    { numer: '50488198573', nombre: 'Deylin', descripcion: 'Experto en tecnología y automatización' }
  ];
