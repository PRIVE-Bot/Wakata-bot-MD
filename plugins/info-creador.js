...
let handler = async (m, { conn }) => {
  ...
  await sendContactArray(conn, m.chat, [
    [`${suittag}`, `ᰔᩚ creador1`, creador, `❀ No Hacer Spam`, correo, `⊹˚• honduras •˚⊹`, XD, bio],
    [`${conn.user.jid.split('@')[0]}`, `✦ ᴇs ᴜɴ ᴄʀᴇᴀᴅᴏʀ ᴅᴇ ʙᴏᴛs`, ʙʀᴀʏᴀɴ, dev, correo, `ᴍᴇxɪᴄᴏ`, channel, biocreador]
  ], m);
}
