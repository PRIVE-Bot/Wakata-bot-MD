...
/**
 * Convertir SVG a imagen usando ImageMagick
 * @param {string} svg
 * @param {string} format
...
/**
 * Renderizar imagen final desde SVG
 */
const render = async ({
  wid = '',
...
if (process.argv[1].endsWith('welcome.js')) {
  render({
    wid: '1234567890',
    name: 'John Doe',
    text: 'Hola mundo\nTesting welcome',
    ...
    writeFileSync(join(src, 'test_output.jpg'), buf);
    console.log('Imagen generada en src/test_output.jpg');
  }).catch(console.error);
}