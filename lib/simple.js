...
const _makeWaSocket = baileys.default || baileys.makeWASocket;
const makeWALegacySocket = baileys.makeWALegacySocket;
...
END:VCARD
        ...
        sendNCarousel: {
            async value(
                ...
                const messageContent = baileys.proto.Message.fromObject({
                    viewOnceMessage: {
                        message: {
                            messageContextInfo: {
                                deviceListMetadata: {},
...
export function smsg(conn, m, hasParent) {
    ...
    try {
        ...
        m = baileys.proto.WebMessageInfo.create(m);
...
export function serialize() {
    ...
    return Object.defineProperties(baileys.proto.WebMessageInfo.prototype, { 
        conn: {
            value: undefined,
            enumerable: false,
            writable: true,
